document.addEventListener("DOMContentLoaded", function () {
    ...
    $('#saveTakenActionsBtn').on('click', async function () {
        ...
        try {
            const res = await fetch('/SocialMedias/UpdateTakenActions', {
                method: 'POST',
            ...
            { data: 'note', width: '300px' },
            {
                ...
                render: function (_, __, row) {
                    ...
                    return `<div class="d-flex gap-1 justify-content-center">
                        <a href="/SocialMedias/Edit/${row.id}" class="btn btn-secondary btn-sm">Düzəliş et</a>
                        <a href="/SocialMedias/Delete/${row.id}" class="btn btn-danger btn-sm">Sil</a>
                    </div>`;
                }
            }
        ],
